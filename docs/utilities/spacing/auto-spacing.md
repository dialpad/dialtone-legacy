...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "Classes" %}
        {% paragraph %}The Stack and Flow layouts work by using the adjacent sibling combinator ({% code %}+{% endcode %}) to apply a top or left margin to sibling elements. This means it will only work when there are more than two sibling items. To allow for differing nesting spacing values, these margins are scoped to apply <strong>only</strong> to direct children of the parent (e.g. {% code %}.d-stack[#] > * + *{% endcode %}).{% endparagraph %}
    </header>
    <table class="d-table">
        <thead>
            <tr>
...
<section class="d-stack8">
    {% header "h2", "Adding space vertically" %}
    <aside class="d-bar8 d-of-hidden">
        <header class="d-fl-center d-p24 d-bgc-purple-100 d-w100p d-hmn216">
...
<section class="d-stack8">
    {% header "h2", "Adding space horizontally" %}
    <aside class="d-bar8 d-of-hidden">
        <header class="d-fl-center d-p24 d-bgc-purple-100 d-w100p d-hmn216">
