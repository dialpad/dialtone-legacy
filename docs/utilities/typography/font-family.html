...
<section class="d-stack8">
  ...
  <table class="d-table">
    ...
    <tbody>
      {% for i in type.font-family %}
        {% assign v = i.var %}
        {% assign o = i.output %}
        {% if v != "unset" %}
          <tr>
            <td class="d-ff-mono d-fc-purple d-fw-normal d-fs12">var(--ff-{{ v }})</td>
            <td class="d-ff-mono d-fc-orange d-fs12">{{ o }}</td>
          </tr>
        {% endif %}
      {% endfor %}
    </tbody>
  ...
  <table class="d-table">
    ...
    <tbody>
      {% for i in type.font-family %}
        ...
        {% assign o = i.output %}
        <tr>
          <td class="d-ff-mono d-fc-purple d-fw-normal d-fs12">.d-ff-{{ v }}</td>
          <td class="d-ff-mono d-fc-orange d-fs12">font-family: {{ o }} !important;</td>
        </tr>
      {% endfor %}
    </tbody>
  </table>
...
<section class="d-stack16">
  <header class="d-stack2">
    {% header "h2", "Custom" %}
    {% paragraph %}Use {% code %}d-ff-custom{% endcode %} to apply the theme's font-family.{% endparagraph %}
  </header>
...
<section class="d-stack16">
  <header class="d-stack2">
    {% header "h2", "Sans-serif" %}
    {% paragraph %}Use {% code %}d-ff-sans{% endcode %} to apply a Sans-Serif font stack.{% endparagraph %}
  </header>
  <aside class="d-bar8 d-of-hidden">
    <header class="d-d-flex d-jc-center d-fd-column d-p24 d-bgc-black-050 d-w100p d-hmn102">
...
<section class="d-stack16">
  <header class="d-stack2">
    {% header "h2", "Mono" %}
    {% paragraph %}Use {% code %}d-ff-mono{% endcode %} to apply a Sans-Serif font stack.{% endparagraph %}
  </header>
  <aside class="d-bar8 d-of-hidden">
    <header class="d-d-flex d-jc-center d-fd-column d-p24 d-bgc-black-050 d-w100p d-hmn102">
...
<section class="d-stack16">
  <header class="d-stack2">
    {% header "h2", "Marketing" %}
    {% paragraph %}Dialtone supports select marketing fonts and weights. Use the following combinations to apply the marketing font stack.{% endparagraph %}
  </header>
  <aside class="d-bar8 d-of-hidden">
    <header class="d-d-flex d-jc-center d-fd-column d-p24 d-bgc-black-050 d-w100p d-hmn102">
