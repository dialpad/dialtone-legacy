...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "Usage" %}
        {% paragraph %}Use {% code %}d-ta-{n}{% endcode %} to change an element's text alignment.{% endparagraph %}
    </header>
    <aside class="d-bar8 d-of-hidden">
        <header class="d-p24 d-bgc-purple-100 d-bgo50 d-w100p d-hmn102 d-of-auto">
