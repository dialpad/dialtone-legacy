...
<section class="d-stack16">
    ...
    <table class="d-table">
        ...
        <tbody>
            {% assign whitespace = "normal, nowrap, pre, pre-line, pre-wrap, break-spaces, unset" | split: ", " %}
            {% for i in whitespace %}
                <tr>
...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "Normal" %}
        {% paragraph %}Use {% code %}d-ws-normal{% endcode %} to collapse an element's text whitespaces sequences and newline characters are treated like whitespace. Lines are broken as needed to fill boxes.{% endparagraph %}
    </header>
...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "No wrap" %}
        {% paragraph %}Use {% code %}d-ws-nowrap{% endcode %} to collapse an element's text whitespaces sequences, but line breaks are not honored. This keeps text from wrapping.{% endparagraph %}
    </header>
    <aside class="d-bar8 d-of-hidden">
...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "Pre" %}
        {% paragraph %}Use {% code %}d-ws-pre{% endcode %} to preserve an element's whitespaces sequences. Lines are only broken at new line characters and {% code %}&lt;br/&gt;{% endcode %} elements.{% endparagraph %}
    </header>
    <aside class="d-bar8 d-of-hidden">
        <header class="d-fl-center d-p24 d-bgc-orange-100 d-bgo50 d-w100p d-hmn102">
...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "Pre Line" %}
        {% paragraph %}Use {% code %}d-ws-pre-line{% endcode %} to collapse an element's whitespaces sequences. Lines are broken at new line characters, {% code %}&lt;br/&gt;{% endcode %} elements, or as needed to fill boxes.{% endparagraph %}
    </header>
    <aside class="d-bar8 d-of-hidden">
...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "Pre Wrap" %}
        {% paragraph %}Use {% code %}d-ws-pre-wrap{% endcode %} to preserve an element's whitespaces sequences. Lines are broken at new line characters, {% code %}&lt;br/&gt;{% endcode %} elements, or as needed to fill boxes.{% endparagraph %}
    </header>
    <aside class="d-bar8 d-of-hidden">
        <header class="d-fl-center d-p24 d-bgc-yellow-100 d-bgo50 d-w100p d-hmn102">
...
<section class="d-stack16">
    <header class="d-stack2">
        {% header "h2", "Break Spaces" %}
        {% paragraph %}Use {% code %}d-ws-break-spaces{% endcode %} to have an element act like {% code %}pre-wrap{% endcode %} except that any sequence of preserved whitespace always takes up space, a line breaking opportunity exists after every preserved whitespace character, and preserved spaces take up space and do not hang which affects the element's intrinisic size ({% code %}min-content{% endcode %} and {% code %}max-content{% endcode %} sizes).{% endparagraph %}
    </header>
    <aside class="d-bar8 d-of-hidden">
