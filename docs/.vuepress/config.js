...
exports.default = (0, vuepress_1.defineUserConfig)({
    ...
    alias: {
        '@data': (0, path_1.resolve)(__dirname, './_data/'),
        '@svgIcons': (0, path_1.resolve)(__dirname, '../../lib/dist/vue/icons/'),
        '@theme': (0, path_1.resolve)(__dirname, './theme'),
        '@customComponents': (0, path_1.resolve)(__dirname, './components'),
    },
});
