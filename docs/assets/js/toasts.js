$(document).ready(function() {
  ...
  const positionClassTypes = ("d-toast--top-right d-toast--top-left d-toast--bottom-right d-toast--bottom-left");
  ...
  function closeToast() {
    ...
    toast.attr('aria-hidden', 'true')
      ...
      .removeClass(positionClassTypes);
  ...
  launchBtn.on('click', function(e) {
    ...
    // Add toast position class
    toast.addClass(toastPositionClass);
  });
