import{_ as v,o as p,c as h,B as b,f as _,a as o,b as e,n as g,h as f,F as x,r as m,e as t,w as a}from"./app.c69bfef1.js";import{D as y}from"./DialtoneUsage.a7d23ee4.js";const w={name:"ExamplePopover",props:{modal:{type:Boolean,default:!1},header:{type:Boolean,default:!1},footer:{type:Boolean,default:!1}},data(){return{shown:!1}},mounted(){window.addEventListener("keyup",n=>{n.key==="Escape"&&this.closeModal()})},beforeUnmount(){window.removeEventListener("keyup",n=>{n.key==="Escape"&&this.closeModal()})},methods:{closeModal(){document.body.classList.remove("d-of-hidden"),this.shown=!1},openModal(){this.modal&&document.body.classList.add("d-of-hidden"),this.shown=!0},togglePopover(){this.shown?this.closeModal():this.openModal()}}},k=["aria-hidden"],q={class:"d-popover d-fl-center d-fd-column d-p24 d-w100p d-of-auto"},C=["aria-expanded"],M=["aria-modal","aria-hidden"],B={key:0,class:"d-popover__header d-px16"},L=e("div",{class:"d-w100p"},`
          This is the header
        `,-1),A=[L],P={class:"d-popover__content d-p16"},T=e("br",null,null,-1),E=e("button",{class:"d-btn d-btn--primary"},`
          Button
      ...
      Click Me
    `,8,C),o(),e("div",{id:"dialog1",class:g(["d-popover__dialog d-popover__dialog--modal d-ps-relative d-t4 d-w264 d-hmx164",i.shown?"d-vi-visible":"d-vi-hidden"]),role:"dialog","aria-modal":r.modal,"aria-hidden":i.shown,"aria-labelledby":"anchor1"},[r.header?(p(),h("div",B,A)):_("v-if",!0),o(),e("div",P,[f(n.$slots,"content",{},()=>[o(`
