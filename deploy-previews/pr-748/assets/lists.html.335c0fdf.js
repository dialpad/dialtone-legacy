import{lists as u}from"./type.367445ea.js";import{_ as h,r as c,o as s,c as t,a as e,e as d,w as o,b as l,d as p,F as _,g as m,t as a,u as f}from"./app.5e51e3f0.js";const g=l("h2",{id:"resetting-a-list",tabindex:"-1"},[l("a",{class:"header-anchor",href:"#resetting-a-list","aria-hidden":"true"},"#"),e(" Resetting a list")],-1),y=p("<p>Use <code>d-ls-reset</code> to reset the margin, padding, and list-style-type of a list. Reseting a list applies to the parent <code>ol</code> or <code>ul</code>, any child <code>li</code> elements, and any child <code>ol</code> or <code>ul</code> elements.</p>",1),b=l("ul",{class:"d-ls-reset d-fc-purple-400 d-fs-200"},[l("li",null,"An unordered list item"),e(),l("li",null,[l("ol",null,[l("li",null,"An ordered list item"),e(),l("li",null,"An ordered list item")])]),e(),l("li",null,"An unordered list item")],-1),w=l("div",{class:"language-html","data-ext":"html"},[l("pre",{class:"language-html"},[l("code",null,`<ul class="d-ls-reset">
  <li>...</li>
  <li>
    <ol>
      <li>...</li>
