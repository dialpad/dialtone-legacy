import{_ as p,s as u,v as h,x as b,y as e,C as s,Q as a,a3 as v,a4 as g,E as m,S as _,G as c,F as x,a5 as k,a6 as f}from"./framework-bc192251.js";const y={name:"ExampleToast",data(){return{kind:"base",showToast:!1,important:!1}},computed:{toastClass(){return"d-toast--"+this.kind},shouldBeInverted(){return this.important&&!["warning"].includes(this.kind)}},methods:{toggleExample(){this.showToast=!this.showToast}}},l=r=>(k("data-v-3706cf64"),r=r(),f(),r),w={class:"dialtone-example","data-example":"yes","data-code":"yes"},E={class:"dialtone-example__example"},T={class:"lg:d-fd-column lg:d-ai-stretch lg:d-stack8 lg:d-flow0 d-d-flex d-ai-flex-end d-p16 d-bgc-black-100 d-ba d-bc-transparent d-flow16 d-mb8 d-bar4"},I={class:"d-fl-grow1"},C=l(()=>e("div",{class:"d-label d-fs-14"},[e("label",{for:"style-select"},"Style")],-1)),B={class:"d-select d-select--sm"},S=l(()=>e("option",{id:"style-select-base",name:"style-select",value:"base",selected:""},`
        ...
        `)])])]),s(),e("aside",D,[e("div",{class:m(["d-toast",[o.toastClass,{"d-toast--important":t.important}]]),role:"status","aria-hidden":!t.showToast},[e("div",Q,[e("div",W,[a(c(i,{name:"bell",size:"400"},null,512),[[_,t.kind==="base"]]),s(),a(c(i,{name:"alert-circle",size:"400"},null,512),[[_,t.kind==="error"]]),s(),a(c(i,{name:"info",size:"400"},null,512),[[_,t.kind==="info"]]),s(),a(c(i,{name:"check-circle",size:"400"},null,512),[[_,t.kind==="success"]]),s(),a(c(i,{name:"alert-triangle",size:"400"},null,512),[[_,t.kind==="warning"]])]),s(),e("div",j,[q,s(),e("p",H,[s(`
            ...
            Action
          `,2),s(),e("button",{type:"button",class:m(["d-btn d-btn--sm d-btn--circle",o.shouldBeInverted?"d-btn--inverted":"d-btn--muted"]),"aria-label":"Close",onClick:n[3]||(n[3]=(...d)=>o.toggleExample&&o.toggleExample(...d))},[e("span",K,[c(i,{name:"close",size:"200"})])],2)])])],10,G)])],64)}const X=p(y,[["render",L],["__scopeId","data-v-3706cf64"],["__file","ExampleToast.vue"]]);export{X as E};
