export default {
  ...
  expressions: [
    ...
    // Negative spacing
    { from: /var\(--sun1\)/g, to: 'var(--dt-space-100-negative)' },
    { from: /var\(--sun2\)/g, to: 'var(--dt-space-200-negative)' },
    { from: /var\(--sun4\)/g, to: 'var(--dt-space-300-negative)' },
    { from: /var\(--sun6\)/g, to: 'var(--dt-space-350-negative)' },
    { from: /var\(--sun8\)/g, to: 'var(--dt-space-400-negative)' },
    { from: /var\(--sun12\)/g, to: 'var(--dt-space-450-negative)' },
    { from: /var\(--sun16\)/g, to: 'var(--dt-space-500-negative)' },
    { from: /var\(--sun24\)/g, to: 'var(--dt-space-550-negative)' },
    { from: /var\(--sun32\)/g, to: 'var(--dt-space-600-negative)' },
    { from: /var\(--sun48\)/g, to: 'var(--dt-space-650-negative)' },
    { from: /var\(--sun64\)/g, to: 'var(--dt-space-700-negative)' },
    { from: /var\(--sun72\)/g, to: 'var(--dt-space-720-negative)' },
    { from: /var\(--sun84\)/g, to: 'var(--dt-space-730-negative)' },
    { from: /var\(--sun96\)/g, to: 'var(--dt-space-750-negative)' },
    { from: /var\(--sun102\)/g, to: 'var(--dt-space-760-negative)' },
    { from: /var\(--sun114\)/g, to: 'var(--dt-space-775-negative)' },
    { from: /var\(--sun128\)/g, to: 'var(--dt-space-800-negative)' },
    // Variable prefixed with negative
    { from: /-@su1\b|-var\(--su1\)/g, to: 'var(--dt-space-100-negative)' },
    { from: /-@su2\b|-var\(--su2\)/g, to: 'var(--dt-space-200-negative)' },
    { from: /-@su4\b|-var\(--su4\)/g, to: 'var(--dt-space-300-negative)' },
    { from: /-@su6\b|-var\(--su6\)/g, to: 'var(--dt-space-350-negative)' },
    { from: /-@su8\b|-var\(--su8\)/g, to: 'var(--dt-space-400-negative)' },
    { from: /-@su12\b|-var\(--su12\)/g, to: 'var(--dt-space-450-negative)' },
    { from: /-@su16\b|-var\(--su16\)/g, to: 'var(--dt-space-500-negative)' },
    { from: /-@su24\b|-var\(--su24\)/g, to: 'var(--dt-space-550-negative)' },
    { from: /-@su32\b|-var\(--su32\)/g, to: 'var(--dt-space-600-negative)' },
    { from: /-@su48\b|-var\(--su48\)/g, to: 'var(--dt-space-650-negative)' },
    { from: /-@su64\b|-var\(--su64\)/g, to: 'var(--dt-space-700-negative)' },
    { from: /-@su72\b|-var\(--su72\)/g, to: 'var(--dt-space-720-negative)' },
    { from: /-@su84\b|-var\(--su84\)/g, to: 'var(--dt-space-730-negative)' },
    { from: /-@su96\b|-var\(--su96\)/g, to: 'var(--dt-space-750-negative)' },
    { from: /-@su102\b|-var\(--su102\)/g, to: 'var(--dt-space-760-negative)' },
    { from: /-@su114\b|-var\(--su114\)/g, to: 'var(--dt-space-775-negative)' },
    { from: /-@su128\b|-var\(--su128\)/g, to: 'var(--dt-space-800-negative)' },
    // Border radius
