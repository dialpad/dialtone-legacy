...
try {
  ...
  console.log(`Found ${totalPropertiesCount} total ${properties.join(', ')} \
   CSS properties that are not dialtone in this directory.`);
  if (searchIcons) { console.log(`Found ${totalIconsCount} total deprecated icons usage in this directory.`); }
} catch (err) {
  console.error(err);
}
